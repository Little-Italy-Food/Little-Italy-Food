...
const Footer = () => {
  return (
    <footer
      ...
      style={{
        backgroundImage:
          "url('https://ryecountrystore.com/custom/modules/home_treatments/images/bg.jpg')", // Replace with your image URL
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <h3 className="text-orange-500 font-semibold mt-4 mb-2">
              About Us
            </h3>
            <p className="text-sm">
              We bring the authentic taste of Italy to your table with quality
          ...
          <div>
            ...
            <form className="space-y-2">
              ...
              <button
                type="submit"
                className="bg-orange-500 text-white py-2 px-4 rounded-md text-sm hover:bg-orange-600 transition-colors w-full"
              >
                Subscribe
              </button>
            </form>
